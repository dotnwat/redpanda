    ...
    group_member(
      ...
      : group_member(
        member_state{
          ...
          .rebalance_timeout = std::chrono::duration_cast<std::chrono::milliseconds>(rebalance_timeout),
          .session_timeout = std::chrono::duration_cast<std::chrono::milliseconds>(session_timeout),
          .subscription = iobuf{},
          .assignment = iobuf{},
        },
        std::move(group_id),
