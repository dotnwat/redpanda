...
public:
    ...
    /*
     * Block/unblock current node from leadership for new raft groups.
     */
    void block_new_leadership() { _block_new_leadership = true; }
    void unblock_new_leadership() { _block_new_leadership = false; }
