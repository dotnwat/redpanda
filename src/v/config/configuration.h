...
struct configuration final : public config_store {
    ...
    property<std::chrono::milliseconds> group_offset_retention;
    property<std::chrono::milliseconds> group_offset_retention_check_period;
    property<std::optional<bool>> group_offset_retention_enabled;
