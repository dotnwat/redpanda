...
public class VerifiableProducer implements AutoCloseable {
  ...
  private static ArgumentParser argParser() {
    ...
    connectionGroup.addArgument("--bootstrap-server")
        ...
        .help("REQUIRED: The server(s) to connect to. Comma-separated list of "
    ...
    parser.addArgument("--max-messages")
        ...
        .dest("maxMessages")
        .help("Produce this many messages. If -1, produce messages until the "
    ...
    parser.addArgument("--acks")
        ...
        .choices(0, 1, -1)
        .metavar("ACKS")
        .help("Acks required on each produced message. See Kafka docs on acks "
              + "for details.");
    ...
    parser.addArgument("--message-create-time")
        ...
        .metavar("CREATETIME")
        .dest("createTime")
        .help("Send messages with creation time starting at the arguments "
    ...
    parser.addArgument("--value-prefix")
        ...
        .dest("valuePrefix")
        .help("If specified, each produced value will have this prefix with a "
              + "dot separator");
    ...
    parser.addArgument("--repeating-keys")
        ...
        .dest("repeatingKeys")
        .help("If specified, each produced record will have a key starting at "
