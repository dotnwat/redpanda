...
class LogStorageMaxSizeSI(RedpandaTest):
    ...
    def test_stay_below_target_size(self):
        ...
        self.redpanda.set_cluster_config(dict(
            log_storage_target_size=15 * 2**20,))
        ...
        wait_until(target_size_reached, timeout_sec=180, backoff_sec=5)
